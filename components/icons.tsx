...
export const GoogleLogo = ({ size = 20 }: P) => (
  <svg width={size} height={size} viewBox="0 0 20 20">
    <path fill="#4285F4" d="M19.6 10.23c0-.71-.06-1.39-.18-2.05H10v3.88h5.38a4.6 4.6 0 0 1-2 3.02v2.51h3.24c1.89-1.74 2.98-4.3 2.98-7.36Z" />
    <path fill="#34A853" d="M10 20c2.7 0 4.96-.9 6.62-2.41l-3.24-2.51c-.9.6-2.05.96-3.38.96-2.6 0-4.8-1.76-5.59-4.12H1.06v2.59A10 10 0 0 0 10 20Z" />
    <path fill="#FBBC05" d="M4.41 11.92a5.99 5.99 0 0 1 0-3.83V5.5H1.06a10 10 0 0 0 0 9l3.35-2.58Z" />
    <path fill="#EA4335" d="M10 3.96c1.47 0 2.79.51 3.83 1.5l2.87-2.87C14.95.99 12.7 0 10 0A10 10 0 0 0 1.06 5.5l3.35 2.59C5.2 5.72 7.4 3.96 10 3.96Z" />
  </svg>
);
